...
import { FormGroup, FormControl, ReactiveFormsModule, Validators, AbstractControl
 } from '@angular/forms';
...
export class UserRegistrationComponent {
  ...
  form =new FormGroup ({
    ...
    this.passwordConirmPasswordValidator
  )

  passwordConirmPasswordValidator(control: AbstractControl) : {[key : string]:boolean} | null{
